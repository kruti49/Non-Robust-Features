...
learning_rate = 0.001
file_name = 'training_with_negative_robust_dataset'
...
#Load dataset
data_path = "./datasets/negative_robust_CIFAR"
...
if args.resume:
    ...
    checkpoint = torch.load('./checkpoint/negativerobust_ckpt.pth')
...
def test(epoch):
    ...
    if acc > best_acc:
        ...
        if not os.path.isdir('checkpoint'):
            os.mkdir('checkpoint')
        torch.save(state, './checkpoint/negativerobustckpt.pth')
        best_acc = acc
